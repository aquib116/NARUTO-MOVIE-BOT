...
auth_channel = environ.get('AUTH_CHANNEL', '-1002201055953 -1002212499849')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002288116160')).split()]
